...
export const BUCKETS = {
  ...
  const FORMATIONS = [
    ...
    // Three posters in asymmetric 3-col — offset vertically (JAGDA spread)
    {
      ...
      slots: [
        { area: 'A', alignSelf: 'center', width: '68%' },
        { area: 'B', alignSelf: 'center', width: '100%' },
        { area: 'C', alignSelf: 'center', width: '76%' },
      ],
    },
    ...
    // 4-poster — two rows, asymmetric vertical alignment
    {
      ...
      slots: [
        { area: 'A', alignSelf: 'center', width: '74%' },
        { area: 'B', alignSelf: 'center', width: '100%' },
        { area: 'C', alignSelf: 'center', width: '70%', justifySelf: 'end' },
        { area: 'D', alignSelf: 'center', width: '88%' },
      ],
    },
    ...
    // 5-mixed: tall anchor + 4 in 2x2 right — Masahiko FUJII spread reference
    {
      ...
      container: { maxWidth: '94%', margin: '0 auto' },
      slots: [
        { area: 'A', alignSelf: 'center', width: '78%' },
        { area: 'B', alignSelf: 'center', width: '96%' },
        { area: 'C', alignSelf: 'center', width: '72%', justifySelf: 'end' },
        { area: 'D', alignSelf: 'center', width: '74%', justifySelf: 'end' },
        { area: 'E', alignSelf: 'center', width: '88%' },
      ],
    },
    ...
    // 5-posters: staggered 3-2 row
    {
      ...
      container: { maxWidth: '94%', margin: '0 auto' },
      slots: [
        { area: 'A', alignSelf: 'center', width: '76%' },
        { area: 'B', alignSelf: 'center', width: '100%' },
        { area: 'C', alignSelf: 'center', width: '70%' },
        { area: 'D', alignSelf: 'center', width: '92%' },
        { area: 'E', alignSelf: 'center', width: '68%' },
      ],
    },
  ...
  
    {
      ...
      container: { maxWidth: '96%', margin: '0 auto' },
      slots: [
        { area: 'A', alignSelf: 'center', width: '72%' },
        { area: 'B', alignSelf: 'center', width: '100%' },
        { area: 'C', alignSelf: 'center', width: '68%', justifySelf: 'end' },
        { area: 'D', alignSelf: 'center', width: '70%', justifySelf: 'start' },
        { area: 'E', alignSelf: 'center', width: '92%' },
        { area: 'F', alignSelf: 'center', width: '78%' },
      ],
    },
  
    {
      ...
      container: { maxWidth: '96%', margin: '0 auto' },
      slots: [
        { area: 'A', alignSelf: 'center', width: '82%' },
        { area: 'B', alignSelf: 'center', width: '94%' },
        { area: 'C', alignSelf: 'center', width: '70%' },
        { area: 'D', alignSelf: 'center', width: '88%' },
        { area: 'E', alignSelf: 'center', width: '66%' },
        { area: 'F', alignSelf: 'center', width: '100%' },
      ],
    },
  ];
